\chapter[Estado del hardware]{Estado del hardware}
\label{cp:Estado-hardware}
...
El propósito de este relevamiento es servir como referencia para el personal técnico y de compu. Al mapear la topología física y el inventario, se busca facilitar la identificación de conexiones, agilizar el mantenimiento y aportar información de apoyo para la migración de los servidores.
